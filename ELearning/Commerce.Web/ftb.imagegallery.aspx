<%@ Page Language="C#" ValidateRequest=false Trace="false" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<body>
    ...
    <form id="Form1" runat="server" enctype="multipart/form-data">  
		...
		<FTB:ImageGallery id="ImageGallery1" 
			...
			runat="Server" 
            RootImagesFolder="~/images/productimages"
			CurrentImagesFolder="~/images/productimages" />
		<input type="text" name="cReturn" value="<%=Request.QueryString["r"].ToString()%>" style="z-index:0"/>
