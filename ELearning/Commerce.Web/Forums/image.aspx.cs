...
// in file 'App_Code\Migrated\Stub_image_aspx_cs.cs'.
// During runtime, this allows other classes in your web application to bind and access 
// the code-behind page using the abstract base class.
// The associated content page 'image.aspx' was also modified to refer to the new class name.
...
namespace yaf
{
	...
	/// </summary>
    public partial class Migrated_image : image
	{
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			else
			{
				...
				Response.Write("Please do not link directly to this resource. You must have a session in the forum.");
			}
		}
