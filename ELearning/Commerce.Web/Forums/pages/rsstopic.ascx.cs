...
namespace yaf.pages
{
	...
	public partial class rsstopic : ForumPage
	{
        ...
        protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				case "posts":
					if(!ForumReadAccess & Thread.CurrentPrincipal.Identity.IsAuthenticated)
						Data.AccessDenied();
				...
				case "topics":
					...
					break;
				case "active":
					using(DataTable dt=DB.topic_active(PageBoardID,PageUserID,DateTime.Now + TimeSpan.FromDays(-90),ForumControl.CategoryID))
					{
						foreach(DataRow row in dt.Rows)
						{
