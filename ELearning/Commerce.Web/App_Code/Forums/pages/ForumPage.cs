	...
	public class ForumPage : System.Web.UI.UserControl
	{
		...
		private void ForumPage_Load(object sender, System.EventArgs e) 
		{
			...
			*/
			...
			{
				case AuthType.Guest:
					typeUser = "yaf.GuestUser,App_Code";
					break;
				...
				case AuthType.Windows:
                    typeUser = "yaf.WindowsUser,App_Code";
					break;
				case AuthType.Portal:
					typeUser = "Portal.ForumUser,Portal";
					break;
				default:
                    typeUser = "yaf.FormsUser,App_Code";
					break;
			}
		...
		protected override void Render(System.Web.UI.HtmlTextWriter writer) 
		{
			if(m_bShowToolBar) 
			{
				writer.WriteLine("<link type='text/css' rel='stylesheet' href='{0}forum.css' />",ResolveUrl( Data.ForumRoot));
				...
				{
					footer.AppendFormat("Main Forum Rss Feed : <a href=\"{0}\"><img valign=\"absmiddle\" src=\"{1}images/rss.gif\" alt=\"RSS\" /></a><br /><br />",Forum.GetLink(Pages.rsstopic,"pg=forum"),ResolveUrl(Data.ForumRoot));
		...
		public string GetThemeContents(string page,string tag) 
		{
            ...
            contents = contents.Replace("~", String.Format("{0}themes/{1}", ResolveUrl(Data.ForumRoot), themeDir));
			return contents;
		}
		...
		{
			return ResolveUrl( ThemeDir)  + filename;
		}
		#endregion
