...
function FTB_InsertImage() {
	...
	//hacked so we could use with other things.
	ctrl=document.getElementById('cReturn').value;
	//window.opener.getElementById(tbox).value=src;
	//alert(tbox);
	eval("opener.document.forms[0]."+ctrl+".value=src");
	window.close();
};
